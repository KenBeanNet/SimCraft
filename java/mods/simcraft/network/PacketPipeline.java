...
import mods.simcraft.network.packet.PacketMarketItemsSold;
...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, SimPacket> {

    private EnumMap<Side, FMLEmbeddedChannel>           channels;
    private LinkedList<Class<? extends SimPacket>> packets           = new LinkedList<Class<? extends SimPacket>>();
	...
	public void registerPackets() {
		...
		registerPacket(PacketMarketItemsSold.class);
     ...
     */
    public boolean registerPacket(Class<? extends SimPacket> clazz) {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, SimPacket msg, List<Object> out) throws Exception {
        ByteBuf buffer = Unpooled.buffer();
        Class<? extends SimPacket> clazz = msg.getClass();
    ...
    protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg, List<Object> out) throws Exception {
        ...
        Class<? extends SimPacket> clazz = this.packets.get(discriminator);
        if (clazz == null) {
            throw new NullPointerException("No packet registered for discriminator: " + discriminator);
        }

        SimPacket pkt = clazz.newInstance();
    ...
    public void initalise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("simcraft", this);
    }
    ...
    public void postInitialise() {
        ...
        Collections.sort(this.packets, new Comparator<Class<? extends SimPacket>>() {

            @Override
            public int compare(Class<? extends SimPacket> clazz1, Class<? extends SimPacket> clazz2) {
     ...
     */
    public void sendToAll(SimPacket message) {
     ...
     */
    public void sendTo(SimPacket message, EntityPlayerMP player) {
     ...
     */
    public void sendToAllAround(SimPacket message, NetworkRegistry.TargetPoint point) {
     ...
     */
    public void sendToDimension(SimPacket message, int dimensionId) {
     ...
     * @param message The message to send
     */
    public void sendToServer(SimPacket message) {
