...
public class SupplyChestGui extends GuiContainer
{
    ...
    public SupplyChestGui(EntityPlayer par1Player, IInventory par2IInventory)
    {
        super(new SupplyChestContainer(par1Player.inventory, par2IInventory));
